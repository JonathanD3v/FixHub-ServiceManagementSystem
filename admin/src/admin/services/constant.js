...
export const CATEGORY_DETAIL_API = (id) => `${domain}/api/admin/categories/${id}`;

// Order Management APIs
export const ORDERS_API = `${domain}/api/admin/orders`;
export const ORDER_DETAIL_API = (id) => `${domain}/api/admin/orders/${id}`;
export const ORDER_STATUS_API = (id) => `${domain}/api/admin/orders/${id}/status`;
export const ORDER_REFUND_API = (id) => `${domain}/api/admin/orders/${id}/refund`;

// Customer Management APIs
export const CUSTOMERS_API = `${domain}/api/admin/customers`;
export const CUSTOMER_DETAIL_API = (id) => `${domain}/api/admin/customers/${id}`;
export const CUSTOMER_ORDERS_API = (id) => `${domain}/api/admin/customers/${id}/orders`;
...
export const SUPPLIER_DETAIL_API = (id) => `${domain}/api/admin/suppliers/${id}`;
